...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      if(ic.le.xend(2) .and. ic.ge.xstart(2)) then
         ...
         call h5screate_simple_f(ndims, data_count, memspace, hdf_error) 
            ...
            call h5dwrite_f(dset_vx, H5T_NATIVE_DOUBLE,vx(1:nx,ic,xstart(3):xend(3)), &
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vy, H5T_NATIVE_DOUBLE,vy(1:nx,ic,xstart(3):xend(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vz, H5T_NATIVE_DOUBLE,vz(1:nx,ic,xstart(3):xend(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_temp, H5T_NATIVE_DOUBLE,temp(1:nx,ic,xstart(3):xend(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            !call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            !call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            !call h5dwrite_f(dset_fi, H5T_NATIVE_DOUBLE,fi(1:nx,ic,xstart(3):xend(3)), &
               !data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            !call h5pclose_f(plist_id, hdf_error)
...
!====================================================================
      ...
      if(ic.le.xendr(2) .and. ic.ge.xstartr(2)) then
         ...
         call h5screate_simple_f(ndims, data_count, memspace, hdf_error) 
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vx, H5T_NATIVE_DOUBLE,vxr(1:nxr,ic,xstartr(3):xendr(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vy, H5T_NATIVE_DOUBLE,vyr(1:nxr,ic,xstartr(3):xendr(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vz, H5T_NATIVE_DOUBLE,vzr(1:nxr,ic,xstartr(3):xendr(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_sal, H5T_NATIVE_DOUBLE,sal(1:nxr,ic,xstartr(3):xendr(3)), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
