...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      if(ic.le.xend(3) .and. ic.ge.xstart(3)) then
         ...
         call h5screate_simple_f(ndims, data_count, memspace, hdf_error) 
            ...
            call h5dwrite_f(dset_vx, H5T_NATIVE_DOUBLE,vx(1:nx,xstart(2):xend(2),ic), &
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vy, H5T_NATIVE_DOUBLE,vy(1:nx,xstart(2):xend(2),ic), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_vz, H5T_NATIVE_DOUBLE,vz(1:nx,xstart(2):xend(2),ic), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_temp, H5T_NATIVE_DOUBLE,temp(1:nx,xstart(2):xend(2),ic), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_salc, H5T_NATIVE_DOUBLE,salc(1:nx,xstart(2):xend(2),ic), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
            ...
            !call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            !call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            !call h5dwrite_f(dset_fi, H5T_NATIVE_DOUBLE,fi(1:nx,xstart(2):xend(2),ic), &
               !data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            !call h5pclose_f(plist_id, hdf_error)
...
!=====================================================
      ...
      if(ic.le.xendr(3) .and. ic.ge.xstartr(3)) then
         ...
         call h5screate_simple_f(ndims, data_count, memspace, hdf_error) 
            ...
            call h5pcreate_f(H5P_DATASET_XFER_F, plist_id, hdf_error) 
            call h5pset_dxpl_mpio_f(plist_id, H5FD_MPIO_COLLECTIVE_F, hdf_error)
            call h5dwrite_f(dset_sal, H5T_NATIVE_DOUBLE,sal(1:nxr,xstartr(2):xendr(2),ic), &
               data_count,  hdf_error, file_space_id = filespace, mem_space_id = memspace, xfer_prp = plist_id)
            call h5pclose_f(plist_id, hdf_error)
